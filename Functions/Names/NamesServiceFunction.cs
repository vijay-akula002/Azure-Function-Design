...
public class NamesServiceFunction
{
    ...
    public NamesServiceFunction(INamesBackendClient backendClient, ILogger<NamesServiceFunction> logger, IServiceProvider services)
    {
        ...
        CancellationToken ct)
    {
        try
        {
            ...
            var handler = _services.GetRequiredKeyedService<IActionLabelHandler>(action);
